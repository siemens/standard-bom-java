...
> [Documentation](https://github.com/siemens/standard-bom-java/blob/master/README.md).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/siemens/standard-bom-java/issues) that might help you. In case you have found a suitable
...
- Open an [Issue](https://github.com/siemens/standard-bom-java/issues/new).
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment
  ...
  [documentation](https://github.com/siemens/standard-bom-java/blob/master/README.md). If you are looking
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there
  ...
  [bug tracker](https://github.com/siemens/standard-bom-java/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/siemens/standard-bom-java/issues/new). (Since we can't be sure at this point
...
This section guides you through submitting an enhancement suggestion for standard-bom-java, **including completely
...
- Perform a [search](https://github.com/siemens/standard-bom-java/issues) to see if the enhancement has already been
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/siemens/standard-bom-java/issues).

- Use a **clear and descriptive title** for the issue to identify the suggestion.
- Provide a **step-by-step description of the suggested enhancement** in as many details as possible.
- **Describe the current behavior** and **explain which behavior you expected to see instead** and why. At this point
  you can also tell which alternatives do not work for you.
- **Explain why this enhancement would be useful** to most standard-bom-java users. You may also want to point out the
